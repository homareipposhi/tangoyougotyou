...
const GERMAN_Q = GERMAN_VERBS.map(([verb, meaning], i) => {
  const candidates = [];
  ...
  return {
    id: `ger-v${String(i + 1).padStart(3, "0")}`,
    subject: "german",
    c: 1,
    s: "基本動詞200",
    n: i + 1,
    ...
    q: `基本動詞 No.${i + 1}：${meaning} に当たるドイツ語の基本動詞を選びなさい。`,
...
const Q_ALL = [
...

  {
    ...
    q: "保存力だけが仕事をする場合、力学的エネルギーは保存される。",
    a: true,
...

  {
    ...
    q: "正の試験電荷が受ける力の向きが、その点での電場の向きである。",
    a: true,
